const domString = (movieArray,config,whereToPrint, myCollectionMode = false) => {
  ...
  movieArray.forEach((movie, index) => {
    ...
    if (myCollectionMode) {
      strang += `<a class="btn deleteMovieFromColeectionEvent">X</a>`;
    };
    ...
    if (!myCollectionMode) {
      strang +=     `<p><a class="btn btn-primary" role="button">I've Watched It</a> <a class="btn btn-default addMovieToWishlist" role="button">Wishlist</a></p>`;
